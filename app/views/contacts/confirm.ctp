...
<p class="pankuzu"><a href="/">トップページ</a>　>　お問い合わせ　確認</p>
...
<?=$formhidden->hiddenVars(); ?>
<?=$this->element('contact_input'); ?>
<div align="center" style="padding-top:30px;"><?=$xformjp->submit('戻る', array('name'=>'back', 'div'=>false)); ?>
<?=$xformjp->submit('　　送信する　　', array('name'=>'finish', 'div'=>false)); ?></div>
<?=$xformjp->end(); ?>