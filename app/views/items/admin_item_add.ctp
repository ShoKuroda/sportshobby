...
<p class="admin_pankuz"><a href="/admin/index">管理画面トップ</a> > [CSV] 商品登録</p>

<div class="info_box" style="margin-bottom:30px;">
<p>
1. 楽天管理画面の「商品ページ設定」＞「<a href="#" class="screenshot" rel="/img/admin/add_item_step1.gif">CSV更新（変更・削除）</a>」のなかにある<a href="#" class="screenshot" rel="/img/admin/add_item_step2.gif">詳細タイプにチェック</a>を入れてCSVをダウンロードします。 <br />
...
<?= $form->create('Items', array('action'=>'admin_item_add', 'type' => 'file'));?>
