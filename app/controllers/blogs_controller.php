...
class BlogsController extends AppController{
	...
	var $uses = array('Blog','OtherCategory');
	var $paginate = array(
		'conditions' => NULL,
		'fields' => "Blog.*",
		'limit' => 50,
	...
	var $helpers = array('Image','javascript');
	...
	function admin_list() {
		...
		$POST_COLUMN = array("category","title","detail");
		$IMG_CNT = 3;
		...
		//登録時に別のテーブルから値を読むSET		
		$this->set('other_category', $this->OtherCategory->find('list',array("fields" => array("category_cd","category_name"))));
