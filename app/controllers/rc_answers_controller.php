<?php
class RcAnswersController extends AppController{
	
	var $uses = array('RcAnswer','RcQuestion','Category');
	var $paginate = array(
		'conditions' => NULL,
		'fields' => "RcAnswer.*",
		'limit' => 50,
		'order' => array('RcAnswer.created' => 'desc'),
	);
	...
	function admin_list() {
		...
		$POST_COLUMN = array("question_id","answer_detail","display");
		$IMG_CNT = 3;
