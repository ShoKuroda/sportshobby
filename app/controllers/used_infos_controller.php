<?php
class UsedInfosController extends AppController{
	
	var $uses = array('UsedInfo','OtherCategory');
	var $paginate = array(
		'conditions' => NULL,
		'fields' => "UsedInfo.*",
		'limit' => 50,
		'order' => array('UsedInfo.created' => 'desc'),
	);
	...
	function index() {
		...
		$this->set('UsedInfo', $this->paginate('UsedInfo'));
	}
